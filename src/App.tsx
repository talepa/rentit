    ...
    <div className="max-w-7xl mx-auto px-4 py-10 md:px-8">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="space-y-3">
          <h3 className="text-lg font-bold text-primary">Rentit</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Electronics</a></li>
            <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Vehicles</a></li>
            <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Clothing</a></li>
            <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Tools</a></li>
            <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Toys & Games</a></li>
            <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Sports Equipment</a></li>
            <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Home & Garden</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Copyright Policy</a></li>
          </ul>
        </div>
      </div>
