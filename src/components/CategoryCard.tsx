  ...
  return (
    <Link to={`/categories/${id}`} className="group">
      <div className="flex flex-col items-center p-4 transition-all duration-300 transform hover:scale-110 hover:shadow-lg rounded-lg">
        <div 
          className={`w-16 h-16 rounded-full flex items-center justify-center mb-2 shadow-sm group-hover:shadow-md transition-all duration-300 ${color} group-hover:rotate-6 group-hover:scale-110`}
        >
          <img 
            src={icon} 
            alt={name} 
