...
const EnhancedSearchBar: React.FC<SearchBarProps> = ({ className }) => {
    ...
    <div className={`${className} w-full`}>
      <div className="relative flex flex-col gap-3">
        <div className="flex flex-col md:flex-row gap-2">
          ...
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-10 border-[#9bd5e9] focus:ring-[#053e5d] focus:border-[#053e5d] bg-white"
            />
          </div>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button 
                variant="outline" 
                className={`md:w-auto justify-start text-left font-normal border-[#9bd5e9] hover:bg-[#9bd5e9]/10 ${!date ? 'text-gray-500' : ''}`}
              >
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button 
                variant="outline" 
                className={`md:w-auto justify-start text-left font-normal border-[#9bd5e9] hover:bg-[#9bd5e9]/10 ${!category ? 'text-gray-500' : ''}`}
              >
        ...
        {activeFilters.length > 0 && (
          <div className="flex flex-wrap gap-2 mt-1">
            {activeFilters.map((filter, index) => (
              <Badge key={index} variant="secondary" className="bg-[#9bd5e9]/20 hover:bg-[#9bd5e9]/30 text-[#053e5d]">
                {filter}
        ...
        <div className="flex flex-wrap gap-2">
          <Button variant="ghost" size="sm" className="text-white hover:bg-white/20" onClick={handlePopularItems}>
            Popular items
          </Button>
