...
import { Menu, Search, User, FilePlus, BookOpen, Grid2X2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/post-listing" className="text-textdark hover:text-primary px-3 py-2 rounded-md text-sm font-medium flex items-center">
      ...
      {isMenuOpen && (
        <div className="md:hidden animate-fade-in">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t">
            ...
            <Link to="/post-listing" className="flex items-center px-3 py-2 rounded-md text-base font-medium text-textdark hover:text-primary">
