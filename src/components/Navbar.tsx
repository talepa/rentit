        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link to="/categories" className="text-textdark hover:text-primary px-3 py-2 rounded-md text-sm font-medium flex items-center relative after:content-[''] after:absolute after:w-full after:scale-x-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-primary after:origin-bottom-right after:transition-transform after:duration-300 hover:after:scale-x-100 hover:after:origin-bottom-left group transition-all duration-300 hover:translate-y-[-2px]">
              <Grid2X2 className="h-4 w-4 mr-1 group-hover:text-primary transition-colors duration-300 group-hover:rotate-12 transform" />
            ...
            <Link to="/my-bookings" className="text-textdark hover:text-primary px-3 py-2 rounded-md text-sm font-medium flex items-center relative after:content-[''] after:absolute after:w-full after:scale-x-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-primary after:origin-bottom-right after:transition-transform after:duration-300 hover:after:scale-x-100 hover:after:origin-bottom-left group transition-all duration-300 hover:translate-y-[-2px]">
              <BookOpen className="h-4 w-4 mr-1 group-hover:text-primary transition-colors duration-300 group-hover:rotate-12 transform" />
              <span>My Bookings</span>
            </Link>
            <Link to="/messages" className="text-textdark hover:text-primary px-3 py-2 rounded-md text-sm font-medium flex items-center relative after:content-[''] after:absolute after:w-full after:scale-x-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-primary after:origin-bottom-right after:transition-transform after:duration-300 hover:after:scale-x-100 hover:after:origin-bottom-left group transition-all duration-300 hover:translate-y-[-2px]">
              <MessageSquare className="h-4 w-4 mr-1 group-hover:text-primary transition-colors duration-300 group-hover:rotate-12 transform" />
              <span>Messages</span>
            </Link>
            <Link to="/login">
      ...
      {isMenuOpen && (
        <div className="md:hidden animate-fade-in">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t">
            ...
            <Link to="/categories" className="flex items-center px-3 py-2 rounded-md text-base font-medium text-textdark hover:text-primary hover:bg-primary/5 transition-all duration-300 transform hover:translate-x-1">
            ...
            <Link to="/my-bookings" className="flex items-center px-3 py-2 rounded-md text-base font-medium text-textdark hover:text-primary hover:bg-primary/5 transition-all duration-300 transform hover:translate-x-1">
              <BookOpen className="h-4 w-4 mr-2 transition-transform hover:rotate-12" />
              <span>My Bookings</span>
            </Link>
            <Link to="/messages" className="flex items-center px-3 py-2 rounded-md text-base font-medium text-textdark hover:text-primary hover:bg-primary/5 transition-all duration-300 transform hover:translate-x-1">
              <MessageSquare className="h-4 w-4 mr-2 transition-transform hover:rotate-12" />
              <span>Messages</span>
            </Link>
            <Link to="/login" className="block px-3 py-2 rounded-md text-base font-medium text-primary hover:bg-primary hover:text-white transition-all duration-300 transform hover:translate-x-1">
              Login / Sign up
            </Link>
          </div>
        </div>
