...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-[#9bd5e9]/10 to-[#f8fafc]">
      <Navbar />
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 md:py-24 lg:py-32 relative z-10">
          <div className="text-center">
            ...
            <motion.h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white font-poppins drop-shadow-md" initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
            ...
            ease: "easeOut"
              ...
              Welcome to <span className="font-bold text-cyan-950">Rentit</span>
            </motion.h1>
            
            <motion.p className="text-lg md:text-xl mb-8 text-white/90 max-w-2xl mx-auto drop-shadow" initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
        ...
        {/* Animated wave shape */}
        <AnimatedWave fill="#9bd5e9" opacity={0.6} animationDuration={20} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-2xl font-bold text-[#053e5d] relative">
              Popular Categories
              <motion.span className="absolute -bottom-1 left-0 w-12 h-0.5 bg-[#9bd5e9]" initial={{
              scaleX: 0
            }} whileInView={{
              scaleX: 1
            }} viewport={{
          ...
          <Button variant="ghost" className="text-[#053e5d] hover:text-[#0a2247] hover:bg-[#9bd5e9]/10" onClick={() => navigate('/categories')}>
            View All
        ...
        margin: "-100px"
          ...
          {popularCategories.map((category, index) => <motion.div key={category.id} variants={itemVariants} className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group border border-[#9bd5e9]/30">
              <div className="relative h-32 overflow-hidden">
                <img src={category.icon} alt={category.name} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
              ...
              <div className="p-3 flex justify-between items-center">
                ...
                <Button variant="ghost" size="sm" className="text-[#053e5d] hover:text-[#0a2247] hover:bg-[#9bd5e9]/10 p-0 h-auto" onClick={() => handleExploreCategory(category.id)}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        once: true
          ...
          <h2 className="text-xl font-bold text-[#053e5d] relative">
            ...
            <motion.span className="absolute -bottom-1 left-0 w-10 h-0.5 bg-[#9bd5e9]" initial={{
            scaleX: 0
          }} whileInView={{
            scaleX: 1
          }} viewport={{
        ...
        <motion.div className="bg-white p-4 rounded-xl shadow-sm border border-[#9bd5e9]/30" initial={{
        opacity: 0,
        y: 20
      }} whileInView={{
        opacity: 1,
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <Button variant="ghost" className="text-[#053e5d] hover:text-[#0a2247] hover:bg-[#9bd5e9]/10" onClick={() => navigate('/categories?sort=newest')}>
            View All
            <ArrowRight className="ml-1 h-4 w-4" />
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {recentListings.map((item, idx) => <motion.div key={item.id} initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
          ...
          delay: idx * 0.1
              ...
              <div className="relative overflow-hidden h-48">
                ...
                <div className="absolute top-0 left-0 m-3">
                  <motion.span className="inline-block bg-[#053e5d] text-white text-xs px-2 py-1 rounded" whileHover={{
                scale: 1.05
              }}>
                    {item.listed}
                  </motion.span>
              ...
              <div className="p-4">
                ...
                <div className="mt-3 flex justify-between items-center">
                  ...
                  <Button variant="outline" size="sm" className="text-xs h-8 border-[#053e5d] text-[#053e5d] hover:bg-[#053e5d] hover:text-white" onClick={() => handleRentNow(item.id)}>
                    Rent Now
                  </Button>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <Button variant="ghost" className="text-[#053e5d] hover:text-[#0a2247] hover:bg-[#9bd5e9]/10" onClick={() => navigate('/categories?trending=true')}>
            View All
            <ArrowRight className="ml-1 h-4 w-4" />
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {trendingItems.map((item, idx) => <motion.div key={item.id} initial={{
          opacity: 0,
          scale: 0.95
        }} whileInView={{
          opacity: 1,
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <Button variant="ghost" className="text-[#053e5d] hover:text-[#0a2247] hover:bg-[#9bd5e9]/10" onClick={() => navigate('/featured')}>
            View All
            <ArrowRight className="ml-1 h-4 w-4" />
          </Button>
        </div>
        
        <FeatureSection title="Featured Products" items={featuredProducts} />
      </div>
    </div>;
};
